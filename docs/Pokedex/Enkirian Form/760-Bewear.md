...
![Fire type](https://archives.bulbagarden.net/media/upload/b/b1/FireIC_BDSP.png){ width=100; align=right;}
</div>
...
graph LR
  ...
  B -->|Level up with a </br><img title="Fire type" src="https://archives.bulbagarden.net/media/upload/b/b1/FireIC_BDSP.png" width="90"></br> pokemon in your party| C[Enkirian Bewear];
```
